...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 45B3A4D7694
	for <lists+mjpeg-users@lfdr.de>; Sun, 13 Mar 2022 16:52:29 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <mjpeg-users-bounces@lists.sourceforge.net>)
	id 1nTQW7-0002eU-4H; Sun, 13 Mar 2022 15:52:21 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <mchehab@kernel.org>) id 1nTIOx-0006Ld-FF
 for mjpeg-users@lists.sourceforge.net; Sun, 13 Mar 2022 07:12:26 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=iR6MCTQH4c7lb2HcgPaKe6eLIwFKJrK7H6I8eI+p7AE=; b=YidOGIzy+WzLujvLYRUZ1IjkFI
 MIe94U2AHICCwli2/EZU2qgH7TvJSjQ8C7nuzSUMksHmKy8ItaZ1XNPO2CkWmnPm46biH+Pdp93/a
 yQb0a1ulqrOMnafEKG1KQAj4aUy6POyVfWv9G2UDck7hUlQsGHWQtwgE4nHm9JFMXIDo=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Owner:List-Archive; bh=iR6MCTQH4c7lb2HcgPaKe6eLIwFKJrK7H6I8eI+p7AE=; b=F
 ZM4guRJeyJm6olMl6GZPx+12IsPYIxcQPVXVAaXvs9YKBTGkKZK4pvVvyuIJ++fQyM3hCNRPH5sdD
 SQSwvHiPMccDz/Hfth3D3LJE6gcoSj8oBPB2tiHInzeFO8j/TtEraValNLnTri6cp/V6A9SWpwQaV
 qBn2XVQ3+iCO0foM=;
Received: from ams.source.kernel.org ([145.40.68.75])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.94.2)
 id 1nTIOt-00032l-7q
 for mjpeg-users@lists.sourceforge.net; Sun, 13 Mar 2022 07:12:25 +0000
...
X-Spam-Report: Spam detection software,
 ...
 Content preview: media Kconfig has two entries associated to V4L API:
 VIDEO_DEV
 and VIDEO_V4L2. On Kernel 2.6.x, there were two V4L APIs, each one with its
 own flag. VIDEO_DEV were meant to: 1) enable Video4Linux and make its Kconfig
 options to appear; 2) it makes the Kernel build the V4L core. 
...
X-Headers-End: 1nTIOt-00032l-7q
X-Mailman-Approved-At: Sun, 13 Mar 2022 15:52:19 +0000
Subject: [Mjpeg-users] [PATCH] media: Kconfig: cleanup VIDEO_DEV dependencies
