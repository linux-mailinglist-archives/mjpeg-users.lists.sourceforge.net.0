...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 725D64D8A70
	for <lists+mjpeg-users@lfdr.de>; Mon, 14 Mar 2022 18:07:43 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <mjpeg-users-bounces@lists.sourceforge.net>)
	id 1nToAY-00085A-VF; Mon, 14 Mar 2022 17:07:42 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <mchehab@kernel.org>) id 1nTnfE-0006UY-VA
 for mjpeg-users@lists.sourceforge.net; Mon, 14 Mar 2022 16:35:19 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=HnPZ/zbVnr4zs4uxw8rvwaz1eZ3AMY3gcz91Vj+sixU=; b=OG2j+hGuqnmObI7gYciwWjkQoc
 RzBo6aZ52Q58BDnnqQlRpLlneC66KKcs8gc7YqntD9h5Za++3g06zeiDRlKJxuxKu8XRfKc4FZQ7E
 r83u36T5CAjuiJ84cKrXPqsty7Rq9TLU/pEzqKGE9YG5nmSqkKhBA7VSDNnyu41tKDk8=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Owner:List-Archive; bh=HnPZ/zbVnr4zs4uxw8rvwaz1eZ3AMY3gcz91Vj+sixU=; b=j
 JS61IiZ1IovEpwTGfVYhv3XMTRy4f6CwxL7Z+632f6JrYmKgLqKSZ74Io0bBcYPQF4N25KPSxNSqz
 ZGGjjBcM+6fiVb+kWePBvHOvjNGrDKvrCuj+O5MYtKcpW/qSpxsQ5pI2Y3iKZFXA9trEZ9A6ZCb74
 vYQZr1TW5365jw5U=;
...
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
 ...
 by dfw.source.kernel.org (Postfix) with ESMTPS id 0E6A96145A;
...
X-Spam-Report: Spam detection software,
 ...
 Content preview: I opted to join two series and one separate patch on a single
 series, as they're related and one depends on the others. That's the second
 version of it. It basically sorts the main media Makefile/Kconfig files and
 reorganizes drivers/media/platform building system. Now, the entries there
 are organized per-vendor, and each per-vendor directory under dr [...] 
...
X-Headers-End: 1nTnf8-0008Cx-K0
X-Mailman-Approved-At: Mon, 14 Mar 2022 17:06:56 +0000
Subject: [Mjpeg-users] [PATCH v2 00/67] media: Kconfig/Makefile reorg
