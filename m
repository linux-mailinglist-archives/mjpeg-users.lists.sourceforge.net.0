...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id ED664B18F0A
	for <lists+mjpeg-users@lfdr.de>; Sat,  2 Aug 2025 15:55:41 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=G/AKs9YaObCEPkZEt7wzrHb2J63M/fGAoWWWrKAoYRw=; b=PHUCw/xxMJfx1JYKOXR1AcCYtZ
	lCc8451bfaVzxTUFNRA21aU8NSh6LP2+UETJQnOCyzTkSUFLg6L4weZWkl/06SO0o5vl6aUjMSzQu
	Nz3qfoxVTT+VdSWMhD9Sk5+0WPxASOyaikHWuriSk51pcHwW2+cD4HDc/6EMWVCRSno0=;
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <mjpeg-users-bounces@lists.sourceforge.net>)
	id 1uiCi4-0006uw-PP;
	Sat, 02 Aug 2025 13:55:40 +0000
Received: from [172.30.29.66] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <jacopo.mondi@ideasonboard.com>) id 1ui8rH-0006Bi-SE
 for mjpeg-users@lists.sourceforge.net;
 Sat, 02 Aug 2025 09:48:56 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=U4L88WbqZibCkP2cpP2Sml3EUSQt5xQleu80TsoowVs=; b=fAaESNWzhDcNQYKuh9PV9+6SYT
 DAm0wo3EoVgF6zlqmnjySou/ue4oH4Xrdav9vzbg9wL9qRcc/1tD9POwP5oIWotqhtcnTQv3R7S3a
 w1G6MxYXCIlO6VnN8NIA1FhhMj+0m0yZbdEZ4lIS72ubmdmH0aXtFD3yYqflTIAlcJLg=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=U4L88WbqZibCkP2cpP2Sml3EUSQt5xQleu80TsoowVs=; b=UvPBAwRz5u6MW7RU8irb++CWKf
 vlC7s+wypiH6iemCbE1hb+Q+E28il6nIAYcpm8ymqIzmE1UmeYUbzSLNWSpBpdo6oFRHqOUnHayDd
 6UAbYdT11aEggC61P7J+tCfDOdMpitbEN21eEadzgCx7wRFXelQN0XI6GPooGJ4Zt+lc=;
Received: from perceval.ideasonboard.com ([213.167.242.64])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1ui8rG-0006RR-Rk for mjpeg-users@lists.sourceforge.net;
 Sat, 02 Aug 2025 09:48:56 +0000
...
X-Spam-Report: Spam detection software,
 ...
 error-prone, as the field is a void * and will happily convert implicitly
 to any pointer type. To avoid direct access to file-> [...] 
...
X-Headers-End: 1ui8rG-0006RR-Rk
X-Mailman-Approved-At: Sat, 02 Aug 2025 13:55:15 +0000
Subject: [Mjpeg-users] [PATCH 08/65] media: Wrap file->private_data access
