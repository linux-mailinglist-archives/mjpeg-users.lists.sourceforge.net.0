...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 9BD5C51D2C7
	for <lists+mjpeg-users@lfdr.de>; Fri,  6 May 2022 10:06:39 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <mjpeg-users-bounces@lists.sourceforge.net>)
	id 1nmsyx-0003r2-2T; Fri, 06 May 2022 08:06:35 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <ian@linux.cowan.aero>) id 1nmqWr-0006pE-0L
 for mjpeg-users@lists.sourceforge.net; Fri, 06 May 2022 05:29:25 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=UvjmCA2tjg0QIc8lFVAb9904tB15YqiWxDu5r4yN82o=; b=mBTUdDhln4cyIpJzx/sG0efMRl
 XH/0WHxG4gzCFnXUKf4NlhMbHI8DOEvVaBJHlOcIgY7mBfIK7WznaJKVedCWur1h7kzKB00KMRue1
 YZVxTfeWBicUU3dD3lZgiTjTn6ny+E1maN5CIaLzMJARzKmHYPl9Eje9ybV4Qwg96XFI=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Owner:List-Archive; bh=UvjmCA2tjg0QIc8lFVAb9904tB15YqiWxDu5r4yN82o=; b=b
 4InDGzyGjZ5hzgKs2TWLK4yZazlLeGAPSqRZhIvxRFe5SaBzEG61PaNwiLvOSq7OKkcq5A/aoIKdd
 /1/WF54qiKNAEEXPHXeAqZbJZi56gr0DS3EG8UegRuJ6s9zIfYe08iAXi6SzkZussJqhRn5yjegyd
 qY5BztRePaieD6cA=;
Received: from gainsboro.ash.relay.mailchannels.net ([23.83.222.65])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.94.2)
 id 1nmqWl-0007PO-N4
 for mjpeg-users@lists.sourceforge.net; Fri, 06 May 2022 05:29:24 +0000
...
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed;
 d=mailchannels.net; s=arc-2022; t=1651814946;
...
ARC-Authentication-Results: i=1; rspamd-fdd564cbf-flc6x;
...
Received: from pdx1-sub0-mail-a243.dreamhost.com (pop.dreamhost.com
 ...
 by 100.96.96.26 (trex/6.7.1); Fri, 06 May 2022 05:29:06 +0000
...
X-Spam-Report: Spam detection software,
 ...
 Content preview: This replaces all of the dprintk macro calls with the
 zrdev_dbg, 
 zrdev_info, or zrdev_err calls as appropriate. This allows for the removal
 of the dprintk macro from each file it is defined in, along [...] 
 ...
 no trust [23.83.222.65 listed in list.dnswl.org]
 -0.1 DKIM_VALID Message has at least one valid DKIM or DK signature
 0.1 DKIM_SIGNED            Message has a DKIM or DK signature, not necessarily
 valid
 -0.1 DKIM_VALID_AU          Message has a valid DKIM or DK signature from
 author's domain
X-Headers-End: 1nmqWl-0007PO-N4
X-Mailman-Approved-At: Fri, 06 May 2022 08:06:34 +0000
Subject: [Mjpeg-users] [PATCH v3 4/4] staging: media: zoran: replace dprintk
