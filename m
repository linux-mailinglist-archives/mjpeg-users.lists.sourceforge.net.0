...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id BE19650AEA3
	for <lists+mjpeg-users@lfdr.de>; Fri, 22 Apr 2022 05:51:54 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <mjpeg-users-bounces@lists.sourceforge.net>)
	id 1nhkKm-0002O1-8K; Fri, 22 Apr 2022 03:51:51 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <ian@linux.cowan.aero>) id 1nhhFW-0001L2-0v
 for mjpeg-users@lists.sourceforge.net; Fri, 22 Apr 2022 00:34:15 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=7rmgAGidBXNPyMlrSnWLxv8N6gOrRYX1OeWPTSrUt6U=; b=fjEU4j2mG4PSb+b7MQUQOm2RGU
 5D2s9icQtz2cLpGRXMC3GA2B3IQJ4FKxmpSn1qg9mOX5L8LsXikk1Bnr/Gd7dsCUDWm0vZjJJY7+z
 ++9Cpp5rVf0lWglYe8Eurho643kS44f6LXfWBGpbMoL1wXatCnabZYG1Fz7/p9sVEpP4=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Owner:List-Archive; bh=7rmgAGidBXNPyMlrSnWLxv8N6gOrRYX1OeWPTSrUt6U=; b=g
 LxS11G2QZdPsLJXQic7DSKGmIw5o7IPu8+UoVKmXZFBLx010ctrSBhtV4JPjIYONdGkb36VAVdPZD
 zhGQ5tVSiCUV3YbOC7jQtdbLRPQsuwLj2j84X4Vj9xqUtdQOvkb9jyrlAQsae5fdcxLC+9hIokgOs
 KUA7Eh01NEYJkAIo=;
Received: from hamster.birch.relay.mailchannels.net ([23.83.209.80])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.94.2)
 id 1nhhFU-0008Sa-03
 for mjpeg-users@lists.sourceforge.net; Fri, 22 Apr 2022 00:34:14 +0000
...
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed;
 d=mailchannels.net; s=arc-2022; t=1650587637;
...
ARC-Authentication-Results: i=1; rspamd-58ff8d7479-x7t22;
...
Received: from pdx1-sub0-mail-a217.dreamhost.com (pop.dreamhost.com
 ...
 by 100.101.255.132 (trex/6.7.1); Fri, 22 Apr 2022 00:33:57 +0000
...
X-Spam-Report: Spam detection software,
 ...
 Content preview: This removed the dprintk() function which used the printk()
 function for kernel debug printing. These have all been replaced with the
 appropriate pr_X() functions. Where the log level is necessary, th [...] 
 ...
 author's domain
X-Headers-End: 1nhhFU-0008Sa-03
X-Mailman-Approved-At: Fri, 22 Apr 2022 03:51:50 +0000
Subject: [Mjpeg-users] [PATCH] staging: media: zoran: modify kernel
 debugging function
